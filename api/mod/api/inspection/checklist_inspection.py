...
def map_inspection_with_checklist_inputs(
    ...
    return InspectionWithChecklistPayload(
        ...
        inputs=mapped,
        outer_packaging_side_images=list(inspection.outer_packaging_side_images or []),
        inner_packaging_side_images=list(inspection.inner_packaging_side_images or []),
        product_side_images=list(inspection.product_side_images or []),
