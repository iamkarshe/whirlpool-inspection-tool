...
/** Use for badges that show an icon + text: same size, uppercase, padded. */
export const BADGE_ICON_CLASS =
  "inline-flex items-center gap-1.5 px-2.5 py-1 text-xs font-medium uppercase [&>svg]:size-3.5 [&>svg]:shrink-0";
