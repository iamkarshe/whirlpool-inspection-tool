...
export default function InboundFailedInspectionsPage() {
  ...
  useEffect(() => {
    ...
    getInspections()
      .then(async (list) => {
        ...
        setInspections(inbound.filter((i) => failedIds.has(i.id)));
      })
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <PageActionBar
          ...
          description="Inbound inspections with at least one failed check (Outer/Inner/Product)."
        />
